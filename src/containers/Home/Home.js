			...
			<div className="bg-brand-2 h-full text-white">
				<div className="container mx-auto">
					...
					<h3 className="text-lg md:text-2xl lg:text-3xl font-base mb-3 font-light">
						An unspoiled Land of Sufi and natural beauty treasure
						for tourists
					</h3>
					<p className="text-sm md:text-base font-thin pb-10 md:pb-5">
						...
						spinning hills covered in lush green tea gardens and
						gleaming paddy fields to olive marshlands and reserved
						forests, Sylhet seems to have been blessed with every
						possible shade of green one can imagine.
					</p>
